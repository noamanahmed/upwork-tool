...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('job_searches', function (Blueprint $table) {
            ...
            $table->string('fixed_rate_minimum')->nullable();
            $table->string('fixed_rate_maximum')->nullable();
            $table->string('proposals_minimum')->nullable();
            $table->string('proposals_maximum')->nullable();
            $table->boolean('is_previous_client')->nullable();
            $table->boolean('is_payment_verified')->nullable();
            $table->string('client_previous_hired_minimum')->nullable();
            $table->string('client_previous_hired_maximum')->nullable();

...
'services.ai.openai.key','services.ai.openai.model','services.ai.openai.conversation_id','services.ai.gemini.key','services.ai.gemini.model',
'services.ai.gemini.conversation_id','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_http_methods','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_status_codes','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','upwork.client_id',
'upwork.client_secret','upwork.redirect_uri','view.paths','view.compiled','ai.default',
'ai.default_for_images','ai.default_for_audio','ai.default_for_transcription','ai.default_for_embeddings','ai.default_for_reranking',
'ai.caching.embeddings.cache','ai.caching.embeddings.store','ai.providers.anthropic.driver','ai.providers.anthropic.key','ai.providers.anthropic.url',
...
'ai.providers.azure.embedding_deployment','ai.providers.bedrock.driver','ai.providers.bedrock.region','ai.providers.bedrock.key','ai.providers.bedrock.access_key_id',
'ai.providers.bedrock.secret_access_key','ai.providers.bedrock.session_token','ai.providers.bedrock.use_default_credential_provider','ai.providers.cohere.driver','ai.providers.cohere.key',
'ai.providers.cohere.url','ai.providers.deepseek.driver','ai.providers.deepseek.key','ai.providers.deepseek.url','ai.providers.eleven.driver',
'ai.providers.eleven.key','ai.providers.gemini.driver','ai.providers.gemini.key','ai.providers.groq.driver','ai.providers.groq.key',
'ai.providers.groq.url','ai.providers.jina.driver','ai.providers.jina.key','ai.providers.jina.url','ai.providers.mistral.driver',
'ai.providers.mistral.key','ai.providers.mistral.url','ai.providers.ollama.driver','ai.providers.ollama.key','ai.providers.ollama.url',
'ai.providers.openai.driver','ai.providers.openai.key','ai.providers.openai.url','ai.providers.openrouter.driver','ai.providers.openrouter.key',
'ai.providers.openrouter.url','ai.providers.voyageai.driver','ai.providers.voyageai.key','ai.providers.voyageai.url','ai.providers.xai.driver',
'ai.providers.xai.key','ai.providers.xai.url','flare.key','flare.flare_middleware','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddLogs.maximum_number_of_collected_logs',
...
'roles.update','roles.destroy','roles.multiDestroy','roles.updateStatus',
'job.proposal',);
        registerArgumentsSet('views', 
'job-proposal','vendor.mail.html.button','vendor.mail.html.footer','vendor.mail.html.header','vendor.mail.html.layout',
...
'vendor.mail.text.subcopy','vendor.mail.text.table','welcome','horizon::layout','laravel-exceptions-renderer::components.badge',

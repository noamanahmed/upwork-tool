...
namespace Illuminate\Support\Facades {
     ...
     */        class Route {
         ...
         * @param mixed $options
         * @static 
         */        public static function apiCrudResource($name, $controller, $options = [])
        {
                        return \Illuminate\Routing\Router::apiCrudResource($name, $controller, $options);
        }
            }
            /**
     * 
...
namespace  {
             ...
             * 
             *
             * @see \App\Providers\AppServiceProvider::bootDebug()
             * @static 
